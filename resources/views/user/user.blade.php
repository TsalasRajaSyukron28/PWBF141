        ...
        <div class="row gy-4 mt-5">
          ...
          <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="hpht" class="stretched-link">Kalkulator Kehamilan</a></h4>
            </div>
          </div>
          <!--End Icon Box -->
          ...
          <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="500">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="tlght" class="stretched-link">Kalkulator Kesuburan</a></h4>
            </div>
          </div>
          <!--End Icon Box -->
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <div class="post-img">
                <img src="assets/user/img/Infokes/infokes1.jpeg" alt="" class="img-fluid">
              </div>
