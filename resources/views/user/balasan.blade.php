					...
					<div class="wrapper">
						<div class="row no-gutters">
				            ...
				            Your message was sent, thank you!
                                    ...
                                    <h3 class="display-12 font-weight-bold text-black">Balasan untuk Anda :</h3>
                                    <table class="table">
                                        <thead>
                                          <tr>
                                            <td scope="col">Id</td>
							...
							<div class="col-lg-6 d-flex align-items-stretch">
								<div class="info-wrap w-100 p-5 img" style="background-image: url(assets/keluh/images/y.jpg);">
			          </div>
							</div>
						</div>
					</div>
